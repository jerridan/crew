...
| `references/simple-path.md`, beside this file | the rest of the run for one package | when the shape is one package |
| `references/full-path.md`, beside this file | the rest of the run for more than one | when the shape is more than one |
...
| More than one package, or work long enough to need steering | Read `references/full-path.md`, beside this file. It owns the rest of the run. |
