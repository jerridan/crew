...
record below exists: the question, `Route: precedent`, the answer, and the
words in the goal you read it from. Nothing else in the record says an
investigation run was chosen rather than fallen into.
